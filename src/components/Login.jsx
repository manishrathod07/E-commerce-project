...
const Login = () => {
  ...
  return (
    <div className="login flex flex-col gap-2 items-center py-2 w-4/12 h-auto shadow-md shadow-gray-600 mx-auto rounded-lg">
      ...
      <form
        action="POST"
        className="w-3/4 flex flex-col gap-6 h-48 justify-center items-center"
      >
        <input
          type="email"
          onChange={(e) => {
        ...
        <input
          ...
          value="Login"
          onClick={submit}
          className="bg-[#00df9a] rounded-xl py-1  text-[14px] w-2/5  text-center hover:scale-105 duration-500 text-white button"
        />
      </form>
